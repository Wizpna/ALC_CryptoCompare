...
public class BtUser_Convert extends AppCompatActivity {
    ...
    public static EditText amount_btc;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_bt_user_convert);
        ...
        amount_btc = (EditText) findViewById(R.id.amount_btc);
    ...
    class RetrieveFeedTask extends AsyncTask<Void, Void, String> {
        ...
        protected String doInBackground(Void... urls) {
            ...
            try {
                ...
                Toast.makeText(BtUser_Convert.this, "No internet Connection", Toast.LENGTH_SHORT).show();
                return null;
            }
        }
                    ...
                    public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                        ...
                        if (!TextUtils.isEmpty(selection)) {
                            if (selection.equals(getString(R.string.aud))) {
                                ...
                                String Aud = amount_btc.getText().toString();
                                ...
                                // Total = Integer.parseInt(usd) * Integer.parseInt(amount_btc.getText().toString());
